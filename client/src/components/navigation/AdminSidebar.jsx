  ...
  return (
    ...
    >
      ...
      <nav className="px-3 py-6 space-y-1 font-clash-medium text-white">
        ...
        <div>
          ...
          {!collapsed && open === "employees" && (
            <div className="ml-9 mt-1 space-y-1">
              <NavLink to="employees-list" className={linkBase}>
        ...
        <NavLink to="create-annoucment" className={linkBase}>
          <FiCalendar size={18} /> {!collapsed && <span>Annoucement</span>}
        </NavLink>
      ...
      <div className="px-3 w-full space-y-1 font-clash-medium absolute bottom-4">
        <NavLink to="/signup" className={linkBase}>
          <FiSettings size={18} />
