  ...
  return (
    <div className="w-full h-full bg-white p-4">
      ...
      <div className="flex flex-wrap mt-[2vw] gap-3">
        {/* chart */}
        <div className="flex flex-col flex-1 md:min-w-[400px] w-[700px] h-[150px] md:h-[350px] bg-[#EEEEEE] p-6 rounded-3xl text-white font-clash-medium">
